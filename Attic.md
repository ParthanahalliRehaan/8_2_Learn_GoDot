...
│   ├── Metroid Dread
│   ├── Silksong
│   ├── MiO: Memories in Orbit (favorite)
│   ├── Constance
│   ├── Nine Sols (least favorite)
│   ├── Solateria
│   ├── Rusted Moss
│   └── Death’s Gambit
│
...
# Others,
# 1. Whats patreon?,Why Pinterest?, For art references, Why LoSpec.com?, For palette reference!,What is itch.io?, Conducts jams, can publish games!
